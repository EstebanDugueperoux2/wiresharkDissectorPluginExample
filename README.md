conan create . -c tools.system.package_manager:mode=install -c tools.system.package_manager:sudo=True --profile:build .conan/profiles/gcc12 --profile:host .conan/profiles/gcc12  --build jupyShark &> build.log
